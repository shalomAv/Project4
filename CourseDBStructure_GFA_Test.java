...
public class CourseDBStructure_GFA_Test {
	...
	public void testHashTable() {
		...
		// CHANGE TO TEST CASE:
		// CRN was 4 characters long fir cde2, that has been changed
		// Create another course
		CourseDBElement cde2 = new CourseDBElement("CMSC600", 44000, 4, "SC100", "Nobody InParticular");
		...
		try {
			// CHANGE TO TEST CASE:
			// CRN was 4 characters long fir cde2, that has been changed
			assertEquals(44000, cds.get(cde2.getCRN()).getCRN());
		} catch (IOException e) {
		...
		try {
			...
			assertEquals("CMSC500", cds.get(cde1Update.getCRN()).getID());
